                                                                                    ...
                                                                                    <form action="EditorialControl" method="post" class="form-horizontal">
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9"><!-- comment -->
                                                                                                <input type="text" name="nit" value="" placeholder="Codigo de la Editorial"/>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                        ...
                                                                                        <div class="form-group">
                                                                                            ...
                                                                                            <div class="col-sm-9"><!-- comment -->
                                                                                                <input type="text" name="email" value="" placeholder="Correo de la Editorial"/>
                                                                                            </div>
                                                                                        </div>
                                                                                        <div class="form-group">
                                                                                            <label class="col-sm-3 control-label no-padding-right">
                                                                                            ...
                                                                                            <div class="col-sm-9">
                                                                                                <input type="text" name="sitioweb" value="" placeholder="Pagina de la Editorial"/>
                                                                                            </div>
                                                                                        </div>
