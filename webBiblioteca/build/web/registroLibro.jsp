<%-- 
    Document   : regitroCategoria
    Created on : 4 jun. 2024, 4:02:18 p. m.
    Author     : Alumno
--%>
                    ...
                    <ul class="nav ace-nav">
                        ...
                        <li class="light-blue dropdown-modal">
                            <a data-toggle="dropdown" href="#" class="dropdown-toggle">
                                <img class="nav-user-photo" src="assets/images/avatars/user.jpg" alt="Senatino's Photo" />
                                        ...
                                        <div>
                                            <form action="EditorialControl" method="post" class="form-horizontal">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9"><!-- comment -->
                                                        <input type="text" name="descripcion" value="" placeholder="Descripcion del Libro"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="col-sm-9"><!-- comment -->
                                                        <input type="text" name="publicacion" value="" placeholder="2023-10-05"/>
                                                    </div>
                                                </div>
                                                <div class="form-group">
                                                    <label class="col-sm-3 control-label no-padding-right">
                                                ...
                                                <button class="btn btn-success" type="submit"><!-- comment -->
                                                    <i class="fa fa-save"></i>
                                                    Registrar
                                                </button>
                                                <button class="btn btn-warning" type="submit"><!-- comment -->
                                                    <i class="fa fa-save"></i>
                                                    Actualizar
                                                </button>
                                                <button class="btn btn-danger" type="submit"><!-- comment -->
                                                    <i class="fa fa-save"></i>
                                                    Eliminar
                                                </button>
                                            </form>
